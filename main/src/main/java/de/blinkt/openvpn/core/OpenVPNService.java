...
//        }
    ...
    private void startOpenVPN(VpnProfile vpnProfile, int startId) {
        ...
        if (!checkVPNPermission(vpnProfile))
            return;

        ProfileManager.setConnectedVpnProfile(this, mProfile);
        VpnStatus.setConnectedVPNProfile(mProfile.getUUIDString());
        keepVPNAlive.scheduleKeepVPNAliveJobService(this, vpnProfile);
    ...
    private static String getTunConfigString(TunConfig tc) {
        ...
        cfg += "excl. routes:" + TextUtils.join("|", tc.mRoutes.getNetworks(false)) + TextUtils.join(
                "|", tc.
